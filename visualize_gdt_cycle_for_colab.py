...
=============================================================================
Copy this entire code block into Google Colab to generate the visualization!

Shows:
1. Full GDT cycle timeline (Buy_Day1-4 → Sell_Day1-4)
2. Which days are MOMENTUM (best edges) vs EXHAUSTION (fade signals)
3. Typical price action on Buy_Day2 (momentum) vs Buy_Day4 (exhaustion)
4. Edge comparison by day type
5. Trading setup summary
=============================================================================
"""
...
# If running in Colab, save to Drive
try:
    plt.savefig('/content/drive/MyDrive/backtest_results/gdt_cycle_momentum_exhaustion.png',
               dpi=300, bbox_inches='tight', facecolor='white')
    print("✓ Saved to Google Drive: gdt_cycle_momentum_exhaustion.png")
except:
    # Otherwise save locally
    plt.savefig('gdt_cycle_momentum_exhaustion.png',
               dpi=300, bbox_inches='tight', facecolor='white')
    print("✓ Saved locally: gdt_cycle_momentum_exhaustion.png")
...
print("="*80)
print("\nKey Takeaways:")
print("1. 🟢 Buy_Day2 = MOMENTUM CONTINUATION (best edges +8-12%)")
print("2. 🔴 Buy_Day4 = EXHAUSTION (fade signals -5-8% edge)")
print("3. 🎯 Gap AGAINST trend on Day 2 = shakeout reversal setup")
print("4. ⚠️ Gap WITH trend on Day 4 = failed breakout/fade")
print("="*80)
