#!/usr/bin/env python3
"""
Trading Day Classification Study - Hourly Analysis
Classifies trading days as Range Day, DWP (Directional With Pullbacks), or DNP (Directional No Pullbacks)
Based on opening price and hourly behavior during RTH (09:30 - 16:15 EST)

Uses 1-hour bars from Yahoo Finance.
Opening price is treated as both opening range high and low.
"""
...
def main():
    ...
    # Configuration
    SYMBOLS = ['SPY', 'QQQ', 'AAPL', 'TSLA', 'NVDA']  # Add your symbols here
    LOOKBACK_DAYS = 20  # Number of trading days to analyze
    ...
    # Export to CSV
    analyzer.export_to_csv("daytype_analysis.csv")
